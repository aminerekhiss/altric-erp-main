...
class Company extends FilamentCompaniesCompany implements HasAvatar
{
    ...
    {
        return $this->hasMany(EmployeeAbsence::class, 'company_id');
    }
    ...
    public function employeeWeekOffs(): HasMany
    {
        return $this->hasMany(EmployeeWeekOff::class, 'company_id');
    }

    public function employeeSalaries(): HasMany
    {
        return $this->hasMany(EmployeeSalary::class, 'company_id');
    }
    ...
    {
        return $this->hasMany(BusinessCompany::class, 'company_id');
    }

    public function accountMessages(): HasMany
    {
        return $this->hasMany(AccountMessage::class, 'company_id');
    }
    ...
    public function parametrableInvoices(): HasMany
    {
        return $this->hasMany(ParametrableInvoice::class, 'company_id');
    }

    public function invoiceStegs(): HasMany
    {
        return $this->hasMany(InvoiceSteg::class, 'company_id');
    }
