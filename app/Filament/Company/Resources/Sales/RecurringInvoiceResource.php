...
use Carbon\Carbon;
use Filament\Forms;
use Filament\Forms\Components\Cluster;
            ...
            ->schema([
                ...
                Forms\Components\Section::make(translate('Invoice Details'))
                    ->schema([
                        Forms\Components\Split::make([
                            ...
                            Forms\Components\Group::make([
                                Forms\Components\TextInput::make('invoice_number')
                                    ...
                                    ->default(static fn () => RecurringInvoice::getNextDocumentNumber())
                                    ->required(),
                        ...
                        Forms\Components\Section::make(translate('Schedule'))
                            ->schema([
                        ...
                        CustomTableRepeater::make('lineItems')
                            ...
                            ->headers(function (Forms\Get $get) use ($settings) {
                                ...
                                $headers = [
                                    Header::make($settings->resolveColumnLabel('item_name', translate('Items')))
                                        ->width('30%'),
                                    Header::make($settings->resolveColumnLabel('unit_name', translate('Quantity')))
                                        ->width('10%'),
                                    Header::make($settings->resolveColumnLabel('price_name', translate('Price')))
                                        ->width('10%'),
                                ];
                                ...
                                $headers[] = Header::make($settings->resolveColumnLabel('amount_name', translate('Amount')))
                                    ->width('10%')
                                    ->align('right');
