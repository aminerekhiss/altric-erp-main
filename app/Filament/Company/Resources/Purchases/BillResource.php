                                ...
                                Forms\Components\Grid::make()
                                    ->schema([
                                        Forms\Components\Select::make('bank_account_id')
                                            ...
                                            ->required()
                                            ->live()
                                            ->options(function (Bill $record) {
                                                return BankAccount::query()
                                                    ->where('bank_accounts.company_id', $record->company_id)
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    ...
                    ReplicateBulkAction::make()
                        ...
                        ->modalDescription(translate('Replicating bills will also replicate their line items. Are you sure you want to proceed?'))
                        ->successNotificationTitle(translate('Bills replicated successfully'))
                        ->failureNotificationTitle(translate('Failed to replicate bills'))
                        ->databaseTransaction()
                        ...
                        ->beforeReplicaSaved(function (Bill $replica) {
                            $replica->forceFill([
                                ...
                                'bill_number' => Bill::getNextDocumentNumber(),
                                'date' => company_today()->toDateString(),
                                'due_date' => company_today()->addDays($replica->company->defaultBill->payment_terms->getDays())->toDateString(),
                            ]);
                        })
